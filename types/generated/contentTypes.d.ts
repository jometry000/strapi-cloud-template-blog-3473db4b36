...
export interface ApiSpecialHourSpecialHour extends Struct.CollectionTypeSchema {
  collectionName: 'special_hours';
  info: {
    description: '';
    displayName: 'Special Hours';
    pluralName: 'special-hours';
    singularName: 'special-hour';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::special-hour.special-hour': ApiSpecialHourSpecialHour;
